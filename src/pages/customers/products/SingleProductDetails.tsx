...
export default function ProductDetails() {
  ...
  return (
    <>
      ...
      {isLoading ? (
        <>
          <SEO title="Loading Product - Kickside Shop" />
        ...
        <>
          <SEO title="Wait a moment, product not found or try again later - Kickside Shop" />
          ...
          <div className="max-w-7xl mx-auto px-4 py-16 min-h-screen flex flex-col items-center justify-center text-center">
            ...
            <p className="text-gray-600 max-w-md mb-8">
              This product is currently unavailable. Please wait a moment or try
              again later.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="px-6 py-2 rounded-lg bg-primary-500 text-white font-medium hover:bg-primary-600 transition"
              >
                Refresh
              </button>
        ...
        <>
          <SEO
            title={`${product?.productName} - Kickside Shop`}
            keywords={
              product?.keywords?.join(', ') ||
              'Shopping, Electronic devices, Manufacturing, Rwanda, E-commerce, Online Shopping, Rwandan Products, Quality Goods, Affordable Prices, Fast Delivery, Secure Payment, Customer Service, Electronics, Fashion, Home Appliances'
            }
            description={`${product.description}`}
            ogImage={product.images?.[0]}
            ogUrl={window.location.href}
            ogTitle={`${product.productName} - Kickside Shop`}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-500 mb-2">
                <div>
                  {product.keywords?.map((keyword) => (
                    <span
                      key={keyword}
                      className="text-white bg-primary-500 px-2 py-1 rounded-full bg-gray-100 mr-2"
                    >
                      {keyword}
                    </span>
                  ))}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[80px_1fr_400px] gap-8">
              {' '}
